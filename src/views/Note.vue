<template>
  <v-container>
    ...
    <v-card>
      <v-card-title>Заметка</v-card-title>
      <v-card-text>
        Для работы с бинарными данными был реализован специальный класс, код которого можно увидеть ниже.
        Он базируется на браузерном BigInt API, которое позволяет хранить целые числа не ограниченной
        размерности. Так же использовалось стандартное API браузера для конвертации между DEC, HEX, BIN.
      </v-card-text>
      <v-card-text>
        <pre>
"use strict"
